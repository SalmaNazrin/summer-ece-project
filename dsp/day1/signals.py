...
x=np.linspace(0,1,1000) #1000 is the sampling frequency
...
#noice in sound wave
np.random.seed(42)
noise = np.random.normal(0, 0.5, size=x.shape) #x.shape means x has 1000 values as assigned . so we can replace size=x.shape with 1000. 
